...
export class DockerFirstMigration1700000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "usage_metrics" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "workspace_id" uuid NOT NULL, "metric_type" character varying(50) NOT NULL, "value" bigint NOT NULL DEFAULT '0', "period" character varying(20), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_14c6ae2b6c1b7114c80fc3c1aec" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_3a5f57e17354e7407757e8793b" ON "refresh_tokens" ("is_revoked") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "role" character varying(50) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "joined_at" TIMESTAMP NOT NULL DEFAULT NOW(), CONSTRAINT "PK_28b53062261b996d9c99fa12404" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "channel_members" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "channel_id" uuid NOT NULL, "member_id" uuid NOT NULL, "joined_at" TIMESTAMP NOT NULL DEFAULT NOW(), CONSTRAINT "unique_channel_member" UNIQUE ("channel_id", "member_id"), CONSTRAINT "PK_95976b619edca48aed364c70c36" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "workspaces" ADD CONSTRAINT "FK_62422395ad425ffda42e4104056" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "feature_flags" ADD CONSTRAINT "FK_9f6fd89ddf4d49c3a5e63b49847" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_metrics" ADD CONSTRAINT "FK_3132f164d6577885e98e0d2896b" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "usage_metrics" DROP CONSTRAINT "FK_3132f164d6577885e98e0d2896b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "feature_flags" DROP CONSTRAINT "FK_9f6fd89ddf4d49c3a5e63b49847"`,
    );
    await queryRunner.query(
      `ALTER TABLE "workspaces" DROP CONSTRAINT "FK_62422395ad425ffda42e4104056"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_channel_members_channel"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3a5f57e17354e7407757e8793b"`,
    );
    await queryRunner.query(
